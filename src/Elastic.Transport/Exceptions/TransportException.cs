...
namespace Elastic.Transport
{
	...
	/// <summary>
	/// Exceptions that occur <see cref="ITransport{TConnectionSettings}.Request{TResponse}"/> are wrapped inside
	...
	public class TransportException : Exception
	{
		...
		/// <see cref="ITransport{TConnectionSettings}.Request{TResponse}"/> up until the moment of this exception
		/// </summary>
