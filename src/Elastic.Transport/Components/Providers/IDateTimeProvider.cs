...
namespace Elastic.Transport
{
	...
	public interface IDateTimeProvider
	{
		...
		/// <param name="minDeadTimeout">The initial dead time as configured by <see cref="ITransportConfigurationValues.DeadTimeout"/></param>
		/// <param name="maxDeadTimeout">The configured maximum dead timeout as configured by <see cref="ITransportConfigurationValues.MaxDeadTimeout"/></param>
