...
/// <summary>
/// A response that omits reading the response body with Elasticsearch error handling.
/// <para>Provides <see cref="IsValidResponse"/>, <see cref="ElasticsearchWarnings"/>,
/// and <see cref="ElasticsearchServerError"/> based on status code and response headers.</para>
/// </summary>
public sealed class ElasticsearchVoidResponse : VoidResponseBase, IElasticsearchResponse
{
	/// <inheritdoc cref="ElasticsearchVoidResponse"/>
	public ElasticsearchVoidResponse() { }
