...
/// <summary>
/// Base class for responses backed by <see cref="JsonNode"/> from System.Text.Json.
///
...
/// </summary>
public abstract class JsonResponseBase : TransportResponse<JsonNode>
{
	/// <inheritdoc cref="JsonResponseBase"/>
