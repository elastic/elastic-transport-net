...
internal sealed class RequestPipelineDiagnosticObserver(
	Action<KeyValuePair<string, BoundConfiguration>> onNextStart,
	Action<KeyValuePair<string, ApiCallDetails>> onNextEnd,
	Action<Exception>? onError = null,
	Action? onCompleted = null
	) : TypedDiagnosticObserver<BoundConfiguration, ApiCallDetails>(onNextStart, onNextEnd, onError, onCompleted)
{
}
